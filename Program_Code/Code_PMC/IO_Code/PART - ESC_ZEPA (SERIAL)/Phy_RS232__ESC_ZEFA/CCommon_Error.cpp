						...
						CII_OBJECT__ALARM *p_alarm)
{
	...
	MessageBox(NULL,msg,
		"CCommon_Error__MODULE_OBJ::Call__ERROR__MODULE_OBJ()",
					   ...
					   CII_OBJECT__ALARM *p_alarm)
{
	...
	MessageBox(NULL,msg,
		"CCommon_Error__MODULE_OBJ::Call__ERROR__ABORTED()",
		MB_OK|MB_TOPMOST|MB_ICONERROR);
					   ...
					   CII_OBJECT__ALARM *p_alarm)
{
	...
	MessageBox(NULL,msg,
		"CCommon_Error__MODULE_OBJ::Call__ERROR__OFFLINE()",
		MB_OK|MB_TOPMOST|MB_ICONERROR);
						   ...
						   CII_OBJECT__ALARM *p_alarm)
{
	...
	MessageBox(NULL,msg,
		"CCommon_Error__MODULE_OBJ::Call__ERROR__NOT_STANDBY()",
		MB_OK|MB_TOPMOST|MB_ICONERROR);
