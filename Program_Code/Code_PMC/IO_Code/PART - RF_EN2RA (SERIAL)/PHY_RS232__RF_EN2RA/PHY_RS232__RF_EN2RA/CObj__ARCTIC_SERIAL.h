...
#include "CObj__ARCTIC_SERIAL__ALID.h"
#include "CObj__ARCTIC_SERIAL__DEF.h"
...
class CObj__ARCTIC_SERIAL : public __IOBJ__IO_TYPE
{
private:
	//-------------------------------------------------------------------------
	...
	// CFG ...
	CX__VAR_ANALOG_CTRL  aCH__CFG_DRV_CHAR_SEDN_DELAY_mSEC;
	CX__VAR_ANALOG_CTRL  aCH__CFG_DRV_LINE_SEDN_DELAY_mSEC;
	...
	// IO CHANNEL  -----------------------------------
	// IO ...
	CX__VAR_DIGITAL_CTRL doCH__DIGITAL_INITIAL_CTRL;
