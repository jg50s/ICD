...
//--------------------------------------------------------------------------------
CObj__RPS_SERIAL::CObj__RPS_SERIAL()
{
...
//--------------------------------------------------------------------------------
int CObj__RPS_SERIAL::__DEFINE__CONTROL_MODE(obj, l_mode)
{
	sObject_Name = obj;
...
int CObj__RPS_SERIAL::__DEFINE__VERSION_HISTORY(version)
{
	version = "2022.01.01 \n";
...
int CObj__RPS_SERIAL::__DEFINE__VARIABLE_STD(p_variable)
{
...
int CObj__RPS_SERIAL::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;
...
int CObj__RPS_SERIAL::__DEFINE__VARIABLE_IO(p_io_variable)
{
...
//--------------------------------------------------------------------------------
int CObj__RPS_SERIAL::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	CString def_name;
	CString def_data;
...
int CObj__RPS_SERIAL::__INITIALIZE__IO(p_io_para)
{
	int com_port = -1;
...
//--------------------------------------------------------------------------------
int CObj__RPS_SERIAL::__CALL__CONTROL_MODE(mode, p_debug, p_variable, p_alarm)
{
	CString log_msg;
	int flag = -1;
...
int CObj__RPS_SERIAL::__CALL__MONITORING(id, p_variable, p_alarm)
{
