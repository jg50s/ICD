...
// ...
void CDB__ALARM_CTRL::Load__ALM_OFFLINE(const int gas_id,const CString& alm_msg)
{
...
void CDB__ALARM_CTRL::Load__ALM_CTRL_TIMEOUT(const int gas_id,const CString& alm_msg)
{
	EnterCriticalSection(&mCS_LOCK);
