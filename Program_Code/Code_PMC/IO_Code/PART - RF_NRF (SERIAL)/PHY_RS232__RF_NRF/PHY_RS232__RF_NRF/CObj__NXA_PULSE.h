...
private:
	...
	// PARA ...
	CX__VAR_ANALOG_CTRL  aCH__PARA_PARAM_A_FREQ;
	CX__VAR_ANALOG_CTRL  aCH__PARA_PARAM_A_DUTY;
	CX__VAR_ANALOG_CTRL  aCH__PARA_PARAM_A_ON_TIME;
	CX__VAR_ANALOG_CTRL  aCH__PARA_PARAM_A_OFF_TIME;

	CX__VAR_ANALOG_CTRL  aCH__PARA_PARAM_B_ON_SHIFT_TIME;
	CX__VAR_ANALOG_CTRL  aCH__PARA_PARAM_B_OFF_SHIFT_TIME;

	CX__VAR_ANALOG_CTRL  aCH__PARA_PARAM_C_ON_SHIFT_TIME;
	CX__VAR_ANALOG_CTRL  aCH__PARA_PARAM_C_OFF_SHIFT_TIME;

	CX__VAR_DIGITAL_CTRL dCH__PARA_CLK_A_CTRL;
	CX__VAR_DIGITAL_CTRL dCH__PARA_CLK_B_CTRL;
	CX__VAR_DIGITAL_CTRL dCH__PARA_CLK_C_CTRL;
	...
	CString sMODE__CLK_A_SET;
	int  Call__CLK_A_SET(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm);

	CString sMODE__CLK_B_SET;
	int  Call__CLK_B_SET(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm);

	CString sMODE__CLK_C_SET;
	int  Call__CLK_C_SET(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm);

	CString sMODE__CLK_EXEC_ON;
	CString sMODE__CLK_EXEC_OFF;
	int  Call__CLK_EXEC_SET(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm, const bool active__clk_on);
