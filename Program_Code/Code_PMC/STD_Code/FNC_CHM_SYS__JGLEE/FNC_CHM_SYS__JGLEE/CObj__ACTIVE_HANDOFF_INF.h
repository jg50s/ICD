...
#include "CObj__ACTIVE_HANDOFF_INF__DEF.h"
...
private:
	...
	CX__VAR_STRING_CTRL  sEXT_CH__PARA_MANUAL_MOVE_SLOT_CLOSE_SKIP;
	CX__VAR_STRING_CTRL  sEXT_CH__PARA_MANUAL_MOVE_LIFT_PIN_SKIP;
