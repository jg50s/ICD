...
private:
	...
	CX__VAR_ANALOG_CTRL	aCH__CFG_RAMP_TIME;
	CX__VAR_ANALOG_CTRL	aCH__CFG_INIT_HE_PRESSURE;
	CX__VAR_ANALOG_CTRL	aCH__CFG_INIT_HE_STABLE_TIME;
	CX__VAR_ANALOG_CTRL aCH__CFG_HE_RAMP_STEP; // 이 기능 관련해서 삭제
	...
	// ECS Center ...
	CX__VAR_ANALOG_CTRL  aEXT_PARAM_ESC_Voltage_CENTER;
	...
	int	 He_Pressure_CTRL(CII_OBJECT__VARIABLE *p_variable,CII_OBJECT__ALARM *p_alarm);
