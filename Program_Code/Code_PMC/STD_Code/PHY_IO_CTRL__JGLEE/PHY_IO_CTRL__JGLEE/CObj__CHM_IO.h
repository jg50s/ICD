...
private:
	...
	// REVERSE.VALVE ...
	int iDATA__REVERSE_VALVE_SIZE;

	CX__VAR_DIGITAL_CTRL  dEXT_CH__REVERSE_VALVE_REF_X[_CFG__REVERSE_VALVE_SIZE];
	CX__VAR_DIGITAL_CTRL  dEXT_CH__REVERSE_VALVE_SUB_X[_CFG__REVERSE_VALVE_SIZE];
	//
