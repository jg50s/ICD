...
private:
	...
	CX__VAR_STRING_CTRL  sCH__INFO_DRV_END_STRING;
	CX__VAR_STRING_CTRL  sCH__INFO_DRV_RECV_TIMEOUT_mSEC;
	CX__VAR_STRING_CTRL  sCH__INFO_DRV_RETRY_COUNT;
	...
	CX__VAR_STRING_CTRL  sCH__MON_MFC_VLV_STS_X[MAX_MFC];

	// IO CHANNEL ...
	CX__VAR_DIGITAL_CTRL dCH__DI_MFC_COMM_STATE_X[MAX_MFC];
	CX__VAR_DIGITAL_CTRL dCH__DI_MFC_VLV_CTRL_X[MAX_MFC];

	CX__VAR_DIGITAL_CTRL dCH__DO_MFC_VERSION_X[MAX_MFC];
	//
