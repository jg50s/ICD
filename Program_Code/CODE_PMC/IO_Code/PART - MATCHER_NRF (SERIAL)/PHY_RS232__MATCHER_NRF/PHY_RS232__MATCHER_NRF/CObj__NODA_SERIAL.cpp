...
//--------------------------------------------------------------------------------
CObj__NODA_SERIAL::CObj__NODA_SERIAL()
{
	m_Rcv_Time	 = 250;
	m_RetryCnt	 = 3;
...
//--------------------------------------------------------------------------------
int CObj__NODA_SERIAL::__DEFINE__CONTROL_MODE(obj, l_mode)
{
	sObject_Name = obj;
...
int CObj__NODA_SERIAL::__DEFINE__VERSION_HISTORY(version)
{
	version = "2022.01.21 \n";
...
#define  APP_DSP__PRESET_SET			"INTERNAL  EXTERNAL  NOT.USE"


int CObj__NODA_SERIAL::__DEFINE__VARIABLE_STD(p_variable)
{
	...
	// PARA ...
	{
		...
		STD__ADD_ANALOG_WITH_OPTION(str_name, "%", 1, 0, 100, -1, "L", "");
		...
		//
		str_name = "PARA.MODE.SET";
		STD__ADD_DIGITAL(str_name,  APP_DSP__MODE_SET);
		LINK__VAR_DIGITAL_CTRL(dCH__PARA_MODE_SET, str_name);

		str_name = "PARA.PRESET.SET";
		STD__ADD_DIGITAL(str_name,  APP_DSP__PRESET_SET);
		LINK__VAR_DIGITAL_CTRL(dCH__PARA_PRESET_SET, str_name);
	}
	...
	// MON ...
	{
		...
		str_name = "MON.PRESET.SET";	 
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__MON_PRESET_SET, str_name);
	...
	// INFO ...
	{
		...
		str_name = "INFO.VDC_VALUE";
		STD__ADD_STRING_WITH_OPTION(str_name, -1, "L", "");
		LINK__VAR_STRING_CTRL(sCH__INFO_VDC_VALUE, str_name);

		str_name = "INFO.IRMS_VALUE";
		STD__ADD_STRING_WITH_OPTION(str_name, -1, "L", "");
		LINK__VAR_STRING_CTRL(sCH__INFO_IRMS_VALUE, str_name);

		str_name = "INFO.POS_VALUE";
		STD__ADD_STRING_WITH_OPTION(str_name, -1, "L", "");
		LINK__VAR_STRING_CTRL(sCH__INFO_POS_VALUE, str_name);
	}
	...
	// INFO,STS ...
	{
		...
		str_name = "INFO.STS.MAT_MATCHING_MODE";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__INFO_STS_MAT_MATCHING_MODE, str_name);

		str_name = "INFO.STS.MAT_PRESET_ENABLE";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__INFO_STS_MAT_PRESET_ENABLE, str_name);

		str_name = "INFO.STS.MAT_MOTOR_ERROR";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__INFO_STS_MAT_MOTOR_ERROR, str_name);

		str_name = "INFO.STS.MAT_IRMS_ERROR";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__INFO_STS_MAT_IRMS_ERROR, str_name);

		str_name = "INFO.STS.MAT_FLOW_ERROR";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__INFO_STS_MAT_FLOW_ERROR, str_name);
		
		str_name = "INFO.STS.MAT_COAX_ERROR";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__INFO_STS_MAT_COAX_ERROR, str_name);

		str_name = "INFO.STS.MAT_TEMPERATURE_ERROR";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__INFO_STS_MAT_TEMPERATURE_ERROR, str_name);
		...
		str_name = "INFO.STS.MAT_PRESET_MODE";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__INFO_STS_MAT_PRESET_MODE, str_name);

		str_name = "INFO.STS.MAT_HD_CON";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__INFO_STS_MAT_HD_CON, str_name);
	}
...
int CObj__NODA_SERIAL::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;
...
int CObj__NODA_SERIAL::__DEFINE__VARIABLE_IO(p_io_variable)
{
	...
	// SI ...
	{
		...
		str_name = "si.VDD.VALUE";
		IO__ADD_STRING_READ__MANUAL(str_name);
		LINK__IO_VAR_STRING_CTRL(siCH__VDD_VALUE, str_name);

		str_name = "si.IRMS.VALUE";
		IO__ADD_STRING_READ__MANUAL(str_name);
		LINK__IO_VAR_STRING_CTRL(siCH__IRMS_VALUE, str_name);

		str_name = "si.POS.VALUE";
		IO__ADD_STRING_READ__MANUAL(str_name);
		LINK__IO_VAR_STRING_CTRL(siCH__POS_VALUE, str_name);
	}

	// AO ...
	{
		str_name = "ao.LOAD.PRESET";
		IO__ADD_ANALOG_WRITE(str_name, "%", 0, 0.0, 100.0);
...
//--------------------------------------------------------------------------------
int CObj__NODA_SERIAL::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	CString def_name;
	CString def_data;
...
int CObj__NODA_SERIAL::__INITIALIZE__IO(p_io_para)
{
	int com_port = -1;
...
//--------------------------------------------------------------------------------
int CObj__NODA_SERIAL::__CALL__CONTROL_MODE(mode, p_debug, p_variable, p_alarm)
{
	CString log_msg;
	int flag = -1;
...
int CObj__NODA_SERIAL::__CALL__MONITORING(id, p_variable, p_alarm)
{
