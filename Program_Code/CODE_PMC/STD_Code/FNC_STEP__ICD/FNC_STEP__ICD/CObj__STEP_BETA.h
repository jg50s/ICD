...
#include "CObj__STEP_BETA__ALID.h"
#include "CObj__STEP_BETA__DEF.h"


class CObj__STEP_BETA : public __IOBJ__STD_TYPE
{
private:
	//-------------------------------------------------------------------------
	...
	CX__VAR_DIGITAL_CTRL dCH__CFG_RCP_PART_USE_APC;	

	// CFG.PROCESS_END ...
	CX__VAR_DIGITAL_CTRL dCH__CFG_PROCESS_END_STATE_RFx_PULSE;	
	CX__VAR_ANALOG_CTRL  aCH__CFG_PROCESS_END_FREQUENCY_RFx_PULSE;	
	CX__VAR_ANALOG_CTRL  aCH__CFG_PROCESS_END_DUTY_RFx_PULSE;	
	CX__VAR_ANALOG_CTRL  aCH__CFG_PROCESS_END_ON_SHIFT_RFx_PULSE;	
	CX__VAR_ANALOG_CTRL  aCH__CFG_PROCESS_END_OFF_SHIFT_RFx_PULSE;	
	...
	//
	CX__VAR_ANALOG_CTRL  aCH__RCP_FRC_CENTER_PERCENT;
	...
	// OBJ FRC ...
	int FRC_OBJ__Start_CONTROL(const CString& para_center);

	bool bActive__OBJ_CTRL__FRC;
	CII_EXT_OBJECT__CTRL *pOBJ_CTRL__FRC;

	CX__VAR_ANALOG_CTRL	 aEXT_CH__FRC_OBJ__CENTER_Wt_SETPOINT;
	...
	CX__VAR_ANALOG_CTRL  aEXT_CH__RF_PULSE__CFG_FREQUENCY_MIN;
	CX__VAR_ANALOG_CTRL  aEXT_CH__RF_PULSE__CFG_FREQUENCY_MAX;
	CX__VAR_ANALOG_CTRL  aEXT_CH__RF_PULSE__CFG_FREQUENCY_DEC;
	...
	CString sDATA__LIFT_PIN__UP;
	CString sDATA__LIFT_PIN__DOWN;
	CString sDATA__LIFT_PIN__MIDDLE;
