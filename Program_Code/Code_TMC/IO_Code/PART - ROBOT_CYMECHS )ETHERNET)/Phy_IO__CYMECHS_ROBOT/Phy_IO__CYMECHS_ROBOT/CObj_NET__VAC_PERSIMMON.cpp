...
int CObj_NET__VAC_PERSIMMON::__DEFINE__VARIABLE_STD(p_variable)
{
	...
	// ...
	{
		...
		str_name = "DRV.RB.STS";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__DRV_RB_STS, str_name);
	}
...
int CObj_NET__VAC_PERSIMMON::__DEFINE__VARIABLE_IO(p_io_variable)
{
	...
	// Digital ...
	{
		...
		// DI
		{
			str_name = "edi.RB1.Sts";
			IO__ADD_DIGITAL_READ__MANUAL(str_name, "Unknown Idle Busy", "");
			LINK__IO_VAR_DIGITAL_CTRL(diCH__RB_STS_READ, str_name);
