...
private:
	...
	// CFG POS.INFO ...
	CX__VAR_DIGITAL_CTRL dCH__CFG_AL1_STN_NUM;
	CX__VAR_DIGITAL_CTRL dCH__CFG_ST1_STN_NUM;

	CX__VAR_DIGITAL_CTRL dCH__CFG_LLx_STN_NUM[CFG_LLx__SIZE];
	CX__VAR_DIGITAL_CTRL dCH__CFG_LLx_1_STN_NUM[CFG_LLx__SIZE];
	CX__VAR_DIGITAL_CTRL dCH__CFG_LLx_2_STN_NUM[CFG_LLx__SIZE];

	CX__VAR_DIGITAL_CTRL dCH__CFG_LPx_STN_NUM[CFG_LPx__SIZE];
	...
	CX__VAR_STRING_CTRL  sCH__MON_SYS_STS__CONTROLLER_BATTERY;
	...
	// DI 
	CX__VAR_DIGITAL_CTRL diCH__RB_STS_AUTO;
	CX__VAR_DIGITAL_CTRL diCH__RB_STS_MANUAL;
	...
	int  Call__CHECK_ERROR_CODE(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm);

	CString sMODE__CHECK_STN_INFO;
	int  Call__CHECK_STN_INFO(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm);
