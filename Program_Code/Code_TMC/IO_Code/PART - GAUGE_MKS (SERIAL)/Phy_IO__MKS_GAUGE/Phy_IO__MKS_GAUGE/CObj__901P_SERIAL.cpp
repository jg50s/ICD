...
//--------------------------------------------------------------------------------
CObj__901P_SERIAL::CObj__901P_SERIAL()
{
...
//--------------------------------------------------------------------------------
int CObj__901P_SERIAL::__DEFINE__CONTROL_MODE(obj, l_mode)
{
	sObject_Name = obj;
...
int CObj__901P_SERIAL::__DEFINE__VERSION_HISTORY(version)
{
	version = "JG.Lee";
...
int CObj__901P_SERIAL::__DEFINE__VARIABLE_STD(p_variable)
{
...
int CObj__901P_SERIAL::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;
...
//-------------------------------------------------------------------------
int CObj__901P_SERIAL::__DEFINE__VARIABLE_IO(p_io_variable)
{
...
//--------------------------------------------------------------------------------
int CObj__901P_SERIAL::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	CString def_name;
	CString def_data;
...
int CObj__901P_SERIAL::__INITIALIZE__IO(p_io_para)
{
	//-------------------------------------------------------
...
//--------------------------------------------------------------------------------
int CObj__901P_SERIAL::__CALL__CONTROL_MODE(mode, p_debug, p_variable, p_alarm)
{
	int r_flag = -1;
...
int CObj__901P_SERIAL::__CALL__MONITORING(id, p_variable, p_alarm)
{
...
int CObj__901P_SERIAL::__CLOSE__OBJECT()
{
