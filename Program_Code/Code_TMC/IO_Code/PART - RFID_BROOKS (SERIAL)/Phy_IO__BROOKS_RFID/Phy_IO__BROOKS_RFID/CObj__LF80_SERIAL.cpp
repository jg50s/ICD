...
//--------------------------------------------------------------------------------
CObj__LF80_SERIAL::CObj__LF80_SERIAL()
{
...
//--------------------------------------------------------------------------------
int CObj__LF80_SERIAL::__DEFINE__CONTROL_MODE(obj,l_mode)
{
	sObject_Name = obj;
...
int CObj__LF80_SERIAL::__DEFINE__VERSION_HISTORY(version)
{
	version = "JG.Lee \n";
...
int CObj__LF80_SERIAL::__DEFINE__VARIABLE_STD(p_variable)
{
...
int CObj__LF80_SERIAL::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;
...
int CObj__LF80_SERIAL::__DEFINE__VARIABLE_IO(p_io_variable)
{
...
//--------------------------------------------------------------------------------
int CObj__LF80_SERIAL::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	CString def_name;
	CString def_data;
	CString str_name;
...
int CObj__LF80_SERIAL::__INITIALIZE__IO(p_io_para)
{
	...
	if(iSim_Flag > 0)
	{
		...
		log_msg.Format("Simulation Mode !!! \n");
...
//--------------------------------------------------------------------------------
int CObj__LF80_SERIAL::__CALL__CONTROL_MODE(mode, p_debug, p_variable, p_alarm)
{
	// ...
	{
		CString log_msg;
...
int CObj__LF80_SERIAL::__CALL__MONITORING(id, p_variable, p_alarm)
{
	switch(id)
	{
