...
private:
	...
	// OBJ_MAINT ...
	CX__VAR_STRING_CTRL  sEXT_CH__OBJ_MAINT__PARA_MANUAL_MOVE_LLx_SLOT_CLOSE_SKIP;
	CX__VAR_STRING_CTRL  sEXT_CH__OBJ_MAINT__PARA_MANUAL_MOVE_PMx_SLOT_CLOSE_SKIP;
	//
	...
	// ...
	void Update__MATERIAL_INFO_TO_MODULE_LINK(const bool active__place_act, const bool active__data_reset);
