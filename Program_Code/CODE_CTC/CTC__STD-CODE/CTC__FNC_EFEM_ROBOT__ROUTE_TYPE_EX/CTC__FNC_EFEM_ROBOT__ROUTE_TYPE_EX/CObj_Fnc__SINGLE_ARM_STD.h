...
#include "CObj_Fnc__SINGLE_ARM_STD__ALID.h"
#include "CObj_Fnc__SINGLE_ARM_STD__DEF.h"


class CObj_Fnc__SINGLE_ARM_STD : public __IOBJ__STD_TYPE
{
private:
	//-------------------------------------------------------------------------
